 ...
 * loading from the body to the matching abstract method. The {@link DocumentMemberDeserVisitor} is
 * provided to reduce the effort of this implementation by providing the default strategies for
 * deserializing content from aggregate type members.
 *
 * <p>Visitor methods for all other types will default to not generating deserialization functions.
 * This may be overwritten by downstream implementations if the protocol requires more complex
 * deserialization strategies for those types.
 *
 * <p>This class reduces the effort necessary to build protocol implementations, specifically when
 * implementing {@link
 * HttpBindingProtocolGenerator#generateDocumentBodyShapeDeserializers(GenerationContext, Set)}.
 *
 ...
 *   <li>Document, List, Map, Set, Structure, Union: generates a deserialization function. <b>Not
 *       overridable.</b>
...
public abstract class DocumentShapeDeserVisitor extends ShapeVisitor.Default<Void> {
   ...
   *
   * <p>Implementations of this method are expected to generate a function body that returns the
   * type generated for the CollectionShape {@code shape} parameter from an input deserialized by
   ...
   *
   * <ul>
   *   <li>{@code output: any}: a value for the CollectionShape shape parameter deserialized from
   *       the document.
   ...
   *
   * <p>Implementations of this method are expected to generate a function body that returns the
   * type generated for the DocumentShape {@code shape} parameter from an input deserialized by
   * {@code deserializeDocument}.
   *
   * <p>For example, given the following Smithy model:
   *
   * <pre>{@code
   ...
   *
   * <ul>
   *   <li>{@code output: any}: a value for the DocumentShape shape parameter deserialized from the
   *       document.
   *   <li>{@code context: SerdeContext}: a TypeScript type containing context and tools for type
   *       serde.
   * </ul>
   ...
   *
   * <p>Implementations of this method are expected to generate a function body that returns the
   * type generated for the MapShape {@code shape} parameter from an input deserialized by {@code
   * deserializeOutputDocument}.
   *
   * <p>For example, given the following Smithy model:
   *
   * <pre>{@code
   ...
   *
   * <ul>
   *   <li>{@code output: any}: a value for the MapShape shape parameter deserialized from the
   *       document.
   *   <li>{@code context: SerdeContext}: a TypeScript type containing context and tools for type
   *       serde.
   * </ul>
   ...
   *
   * <p>Implementations of this method are expected to generate a function body that returns the
   * type generated for the StructureShape {@code shape} parameter from an input deserialized by
   * {@code deserializeOutputDocument}.
   *
   * <p>For example, given the following Smithy model:
   *
   ...
   *
   * <ul>
   *   <li>{@code output: any}: a value for the StructureShape shape parameter deserialized from the
   *       document.
   *   <li>{@code context: SerdeContext}: a TypeScript type containing context and tools for type
   *       serde.
   * </ul>
   ...
   *
   * <p>Implementations of this method are expected to generate a function body that returns the
   * type generated for the UnionShape {@code shape} parameter from an input deserialized by {@code
   * deserializeOutputDocument}.
   *
   * <p>For example, given the following Smithy model:
   *
   ...
   *
   * <ul>
   *   <li>{@code output: any}: a value for the UnionShape shape parameter deserialized from the
   *       document.
   *   <li>{@code context: SerdeContext}: a TypeScript type containing context and tools for type
   *       serde.
   * </ul>
  ...
  protected final void generateDeserFunction(
      Shape shape, BiConsumer<GenerationContext, Shape> functionBody) {
  ...
  /**
   * Dispatches to create the body of map shape deserialization functions. The function signature
   * will be generated.
   *
   * <p>For example, given the following Smithy model:
   *
   ...
   * }</pre>
   *
   * <p>The following code is generated for a deserializer
   *
   * <pre>{@code
  ...
  /**
   * Dispatches to create the body of list shape deserialization functions. The function signature
   * will be generated.
   *
   * <p>For example, given the following Smithy model:
   *
  ...
  /**
   * Dispatches to create the body of set shape deserialization functions. The function signature
   * will be generated.
   *
   * <p>For example, given the following Smithy model:
   *
  ...
  /**
   * Dispatches to create the body of structure shape deserialization functions. The function
  ...
  /**
   * Dispatches to create the body of union shape deserialization functions. The function signature
   * will be generated.
   *
   * <p>For example, given the following Smithy model:
   *
