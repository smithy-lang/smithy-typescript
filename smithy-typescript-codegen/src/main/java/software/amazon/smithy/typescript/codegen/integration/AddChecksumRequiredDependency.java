...
public final class AddChecksumRequiredDependency implements TypeScriptIntegration {
        ...
        return MapUtils.of(
            "streamHasher",
                writer -> {
                  ...
                  writer.addImport(
                      "fileStreamHasher", "streamHasher", TypeScriptDependency.STREAM_HASHER_NODE);
        ...
        return MapUtils.of(
            "streamHasher",
                writer -> {
                  ...
                  writer.addImport(
                      "blobHasher", "streamHasher", TypeScriptDependency.STREAM_HASHER_BROWSER);
                  writer.write("streamHasher");
                },
            "md5",
                writer -> {
  ...
  private static boolean hasChecksumRequiredTrait(
