...
public final class EndpointsV2Generator implements Runnable {
  ...
  public static final String ENDPOINT_PARAMETERS_MODULE =
      Paths.get(
          ...
          .toString();
  public static final Dependency ENDPOINT_PARAMETERS_DEPENDENCY =
      new Dependency() {
        @Override
  ...
  public static final String ENDPOINT_RESOLVER_MODULE =
      Paths.get(
          ...
          .toString();
  public static final Dependency ENDPOINT_RESOLVER_DEPENDENCY =
      new Dependency() {
        @Override
        public String getPackageName() {
  ...
  public EndpointsV2Generator(
      TypeScriptDelegator delegator, TypeScriptSettings settings, Model model) {
            ...
            .orElseThrow(
                () ->
                    new RuntimeException(
                        "service or model preprocessor missing EndpointRuleSetTrait"));
    ...
    this.delegator.useFileWriter(
        ...
        writer -> {
          writer.addTypeImport(
              "EndpointParameters", "__EndpointParameters", TypeScriptDependency.SMITHY_TYPES);
          ...
          writer.openBlock(
              ...
              "}",
              () -> {
                Map<String, String> clientInputParams =
                    ruleSetParameterFinder.getClientContextParams();
                // Omit Endpoint params that should not be a part of the
                // ClientInputEndpointParameters interface
                ...
                ruleSet
                    ...
                    .ifPresent(
                        parameters -> {
                          parameters.accept(
                              new RuleSetParametersVisitor(writer, clientInputParams, true));
                        });
              });
    ...
    this.delegator.useFileWriter(
        ...
        writer -> {
          ...
          writer.write(
              ...
              """,
              ruleSetParameterFinder.getEffectiveParams().stream()
