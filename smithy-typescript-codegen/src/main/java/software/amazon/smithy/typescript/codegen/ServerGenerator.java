...
final class ServerGenerator {
  ...
  static void generateOperationsType(
    ...
    writer.writeInline(
        "export type $L = ", serviceSymbol.expectProperty("operations", Symbol.class).getName());
  ...
  static void generateServiceHandler(
    ...
    writer.openBlock(
        ...
        () -> {
          ...
          writer.write(
              "private readonly mux: __Mux<$S, $T>;",
          ...
          writer.write(
              "private readonly validationCustomizer: __ValidationCustomizer<$T>;", operationsType);
          writer.writeDocs(
              () -> {
                writer.write("Construct a $T handler.", serviceSymbol);
                writer.write(
                    "@param service The {@link $1T} implementation that supplies the business logic"
                        + " for $1T",
                    serviceSymbol);
                writer.writeInline(
                    "@param mux The {@link __Mux} that determines which service and operation are"
                        + " ");
                writer.write("being invoked by a given {@link __HttpRequest}");
                writer.writeInline(
                    "@param serializerFactory A factory for an {@link __OperationSerializer} for"
                        + " each ");
                ...
                writer.write(
                    "@param validationCustomizer A {@link __ValidationCustomizer} for turning"
                        + " validation failures into {@link __SmithyFrameworkException}s");
              });
          writer.openBlock(
              "constructor(",
              ") {",
              () -> {
                ...
                writer.write(
                    ...
                    serviceSymbol);
                writer.write(
                    "serializeFrameworkException: (e: __SmithyFrameworkException, ctx:"
                        + " __ServerSerdeContext) => Promise<__HttpResponse>,");
          ...
          writer.openBlock(
              ...
              () -> {
                ...
                writer.openBlock(
                    ...
                    () -> {
                      writer.write(
                          "return this.serializeFrameworkException(new"
                              + " __UnknownOperationException(), serdeContextBase);");
                    });
                writer.openBlock(
                    ...
                    () -> {
                      for (OperationShape operation : operations) {
                        ...
                        Symbol inputSymbol =
                            operationSymbol.expectProperty("inputType", Symbol.class);
                        writer.openBlock(
                            "case $S : {",
                            "}",
                            ...
                            () -> {
                              writer.write(
                                  "return handle(request, context, $1S,"
                                      + " this.serializerFactory($1S), this.service.$1L,"
                                      + " this.serializeFrameworkException, $2T.validate, "
  ...
  static void generateOperationHandler(
    ...
    writer.openBlock(
        ...
        () -> {
          writer.write(
              "private readonly operation: __Operation<$T, $T, Context>;",
              inputSymbol,
              outputSymbol);
          writer.write(
              "private readonly mux: __Mux<$S, $S>;",
              serviceShape.getId().getName(),
              operationName);
          writer.write(
          ...
          writer.write(
              "private readonly serializeFrameworkException: (e: __SmithyFrameworkException, "
                  + "ctx: __ServerSerdeContext) => Promise<__HttpResponse>;");
          writer.write(
              "private readonly validationCustomizer: __ValidationCustomizer<$S>;", operationName);
          writer.writeDocs(
              () -> {
                writer.write("Construct a $T handler.", operationSymbol);
                writer.write(
                    "@param operation The {@link __Operation} implementation that supplies the"
                        + " business logic for $1T",
                    operationSymbol);
                writer.writeInline(
                    "@param mux The {@link __Mux} that verifies which service and operation are"
                        + " being ");
                writer.write("invoked by a given {@link __HttpRequest}");
                writer.write(
                    "@param serializer An {@link __OperationSerializer} for $T that ",
                    operationSymbol);
                writer
                    .writeInline("                  ")
                    .write("handles deserialization of requests and serialization of responses");
          ...
          writer.openBlock(
              ...
              () -> {
                ...
                writer.openBlock(
                    ...
                    () -> {
                      writer.write(
                          "console.log('Received a request that did not match $L.$L. This indicates"
                              + " a misconfiguration.');",
                          serviceShape.getId(),
                          operation.getId().getName());
                      writer.write(
                          "return this.serializeFrameworkException(new"
                              + " __InternalFailureException(), serdeContextBase);");
                    });
                writer.write(
                    "return handle(request, context, $S, this.serializer, this.operation,"
                        + " this.serializeFrameworkException, $T.validate,"
                        + " this.validationCustomizer);",
                    operationName,
                    inputSymbol);
              });
  ...
  private static void addCommonHandlerImports(TypeScriptWriter writer) {
    ...
    writer.addImport(
        ...
        TypeScriptDependency.SERVER_COMMON);
    writer.addImport(
        "SerializationException", "__SerializationException", TypeScriptDependency.SERVER_COMMON);
    writer.addImport(
  ...
  private static void writeHandleFunction(TypeScriptWriter writer) {
    ...
    writer.addImport(
        "ValidationCustomizer", "__ValidationCustomizer", TypeScriptDependency.SERVER_COMMON);
    writer.addImport(
        "isFrameworkException", "__isFrameworkException", TypeScriptDependency.SERVER_COMMON);
    ...
    writer.write(
        "return serializeFrameworkException(new __SerializationException(), "
            + "serdeContextBase);");
    writer.closeBlock("}");
    writer.openBlock(
        "try {",
          ...
          writer.openBlock(
              ...
              () -> {
                ...
                writer.openBlock(
                    ...
                    () -> {
                      writer.write(
                          "return serializer.serializeError(validationException,"
                              + " serdeContextBase);");
                    });
              });
    ...
    writer.write(
        "return serializeFrameworkException(new __InternalFailureException(), "
            + "serdeContextBase);");
    writer.closeBlock("}");
    writer.closeBlock("}");
  }
  ...
  private static void writeSerdeContextBase(TypeScriptWriter writer) {
    writer.addImport(
        "ServerSerdeContext", "__ServerSerdeContext", TypeScriptDependency.SERVER_COMMON);
