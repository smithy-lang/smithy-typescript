...
public class CborMemberDeserVisitor extends DocumentMemberDeserVisitor {
   ...
   * `context.base64Decoder(...)`. The CBOR format deserializer already does this whereas e.g.
   * JSON.parse does not.
   */
  @Override
  ...
  /**
   * Smithy RPCv2 CBOR only allows the epoch-seconds format, ignoring the model's timestamp trait.
   */
  @Override
