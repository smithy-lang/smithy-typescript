...
public class ImportFrom {
  public static final Set<String> NODE_NATIVE_DEPENDENCIES =
      SetUtils.of(
          "buffer",
          "child_process",
          "crypto",
  ...
  /**
   * @return whether we recognize it as a Node.js native module. These do not need to be declared in
   *     package.json. This check is not exhaustive since the list of native modules varies by
   *     version.
   */
  ...
  /**
   * @return whether the import starts with / or . indicating a relative import. These would not be
  ...
  /**
   * @return whether the import should correspond to an entry in package.json.
   */
   ...
   *     <p>For example in \@smithy/pkg/module the package name is \@smithy/pkg.
   */
