 ...
 *
 * <p>Currently this is used to generate the the HttpAuthSchemeParameters interface.
 *
 * @param name name of the auth scheme parameter
 * @param type writer for the type of the auth scheme parameter
 * @param source writer for the value of the auth scheme parameter, typically from {@code context}
 *     or {@code config}
 */
@SmithyUnstableApi
public record HttpAuthSchemeParameter(
    String name, Consumer<TypeScriptWriter> type, Consumer<TypeScriptWriter> source)
