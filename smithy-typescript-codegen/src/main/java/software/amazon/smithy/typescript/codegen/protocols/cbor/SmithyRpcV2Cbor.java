...
public class SmithyRpcV2Cbor extends HttpRpcProtocolGenerator {
  ...
  public void generateSharedComponents(GenerationContext context) {
    ...
    writer.addImportSubmodule(
        "buildHttpRpcRequest", null, TypeScriptDependency.SMITHY_CORE, SmithyCoreSubmodules.CBOR);
  ...
  protected void generateDocumentBodyShapeSerializers(
      GenerationContext generationContext, Set<Shape> shapes) {
    SmithyProtocolUtils.generateDocumentBodyShapeSerde(
        generationContext, shapes, new CborShapeSerVisitor(generationContext));
  }
  ...
  protected void generateDocumentBodyShapeDeserializers(
      GenerationContext generationContext, Set<Shape> shapes) {
    SmithyProtocolUtils.generateDocumentBodyShapeSerde(
        generationContext, shapes, new CborShapeDeserVisitor(generationContext));
  }
  ...
  protected String getOperationPath(
      GenerationContext generationContext, OperationShape operationShape) {
  ...
  protected void deserializeOutputDocument(
    ...
    writer.write(
        "contents = $L;",
        outputStructure.accept(new CborMemberDeserVisitor(generationContext, "data")));
  }
