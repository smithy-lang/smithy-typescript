...
public class SupportHttpApiKeyAuth implements HttpAuthTypeScriptIntegration {
  private static final Consumer<TypeScriptWriter> HTTP_API_KEY_AUTH_SIGNER =
      w ->
          w.write(
              "new $T()",
              Symbol.builder()
                  ...
                  .build());
  private static final Symbol API_KEY_IDENTITY =
      Symbol.builder()
          .name("ApiKeyIdentity")
          .namespace(TypeScriptDependency.SMITHY_TYPES.getPackageName(), "/")
          .addDependency(TypeScriptDependency.SMITHY_TYPES)
          .build();
  private static final Symbol API_KEY_IDENTITY_PROVIDER =
      Symbol.builder()
          .name("ApiKeyIdentityProvider")
          .namespace(TypeScriptDependency.SMITHY_TYPES.getPackageName(), "/")
          .addDependency(TypeScriptDependency.SMITHY_TYPES)
          .build();
  private static final Symbol HTTP_API_KEY_LOCATION =
      Symbol.builder()
