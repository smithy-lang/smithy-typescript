        ...
        switch (target) {
            case NODE:
                return MapUtils.of(
                        ...
                        writer -> {
                            ...
                            writer.addImport("loadConfig",
                                    "loadNodeConfig",
                                    TypeScriptDependency.NODE_CONFIG_PROVIDER);
                            writer.addImport("NODE_DISABLE_REQUEST_COMPRESSION_CONFIG_OPTIONS",
                                    null,
                        ...
                        writer -> {
                            ...
                            writer.addImport("loadConfig",
                                    "loadNodeConfig",
                                    TypeScriptDependency.NODE_CONFIG_PROVIDER);
                            writer.addImport("NODE_REQUEST_MIN_COMPRESSION_SIZE_BYTES_CONFIG_OPTIONS",
                                    null,
                                    TypeScriptDependency.MIDDLEWARE_COMPRESSION);
                            writer.write(
            ...
            case BROWSER:
                return MapUtils.of(
                        ...
                        writer -> {
                            writer.addDependency(TypeScriptDependency.MIDDLEWARE_COMPRESSION);
                            writer.addImport("DEFAULT_DISABLE_REQUEST_COMPRESSION",
                                    null,
                                    TypeScriptDependency.MIDDLEWARE_COMPRESSION);
                        ...
                        writer -> {
                            writer.addDependency(TypeScriptDependency.MIDDLEWARE_COMPRESSION);
                            writer.addImport("DEFAULT_NODE_REQUEST_MIN_COMPRESSION_SIZE_BYTES",
                                    null,
                                    TypeScriptDependency.MIDDLEWARE_COMPRESSION);
