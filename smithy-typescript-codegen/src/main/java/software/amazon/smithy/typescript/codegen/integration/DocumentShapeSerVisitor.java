 ...
 *
 * <p>Visitor methods for aggregate types are final and will generate functions that dispatch their
 * body generation to the matching abstract method. The {@link DocumentMemberSerVisitor} is provided
 * to reduce the effort of this implementation by providing the default strategies for serializing
 * content from aggregate type members.
 *
 * <p>Visitor methods for all other types will default to not generating serialization functions.
 * This may be overwritten by downstream implementations if the protocol requires more complex
 * serialization strategies for those types.
 *
 * <p>This class reduces the effort necessary to build protocol implementations, specifically when
 * implementing {@link
 * HttpBindingProtocolGenerator#generateDocumentBodyShapeSerializers(GenerationContext, Set)}.
 *
 * <p>Implementations of this class independent of protocol documents are also possible.
 *
 * <p>The standard implementation is as follows; no assumptions are made about the protocol being
 * generated for.
 *
 * <ul>
 *   <li>Service, Operation, Resource: no function generated. <b>Not overridable.</b>
 *   <li>Document, List, Map, Set, Structure, Union: generates a serialization function. <b>Not
 *       overridable.</b>
 *   <li>All other types: no function generated. <b>May be overridden.</b>
 * </ul>
 */
@SmithyUnstableApi
public abstract class DocumentShapeSerVisitor extends ShapeVisitor.Default<Void> {
   ...
   *
   * <p>Implementations of this method are expected to generate a function body that returns a value
   * representing the CollectionShape {@code shape} parameter that is serializable by {@code
   * serializeInputDocument}.
   *
   ...
   *
   * <ul>
   *   <li>{@code input: Array&lt;Parameter&gt;}: the type generated for the CollectionShape shape
   *       parameter.
   *   <li>{@code context: SerdeContext}: a TypeScript type containing context and tools for type
   *       serde.
   * </ul>
   *
   * <p>The function signature specifies an {@code any} return type; the function body should return
   * a value serializable by {@code serializeInputDocument}.
   *
   ...
   *
   * <p>Implementations of this method are expected to generate a function body that returns a value
   * representing the DocumentShape {@code shape} parameter that is serializable by {@code
   * serializeInputDocument}.
   *
   * <p>For example, given the following Smithy model:
   *
   ...
   *
   * <ul>
   *   <li>{@code input: FooDocument}: the type generated for the DocumentShape shape parameter.
   *   <li>{@code context: SerdeContext}: a TypeScript type containing context and tools for type
   *       serde.
   * </ul>
   *
   ...
   *
   * <p>Implementations of this method are expected to generate a function body that returns a value
   * representing the MapShape {@code shape} parameter that is serializable by {@code
   * serializeInputDocument}.
   *
   * <p>For example, given the following Smithy model:
   *
   ...
   *
   * <ul>
   *   <li>{@code input: Record<string, Field>}: the type generated for the MapShape shape
   *       parameter.
   *   <li>{@code context: SerdeContext}: a TypeScript type containing context and tools for type
   *       serde.
   * </ul>
   ...
   *
   * <p>Implementations of this method are expected to generate a function body that returns a value
   * representing the StructureShape {@code shape} parameter that is serializable by {@code
   * serializeInputDocument}.
   *
   * <p>For example, given the following Smithy model:
   *
   ...
   *
   * <ul>
   *   <li>{@code input: Field}: the type generated for the StructureShape shape parameter.
   *   <li>{@code context: SerdeContext}: a TypeScript type containing context and tools for type
   *       serde.
   * </ul>
   *
   ...
   *
   * <p>Implementations of this method are expected to generate a function body that returns a value
   * representing the UnionShape {@code shape} parameter that is serializable by {@code
   * serializeInputDocument}.
   *
   * <p>For example, given the following Smithy model:
   *
   ...
   *
   * <ul>
   *   <li>{@code input: Field}: the type generated for the UnionShape shape parameter.
   *   <li>{@code context: SerdeContext}: a TypeScript type containing context and tools for type
   *       serde.
   * </ul>
   *
  ...
  /**
   * Generates a function for serializing the input shape, dispatching the body generation to the
   * supplied function.
   *
   * @param shape The shape to generate a serializer for.
   * @param functionBody An implementation that will generate a function body to serialize the
   *     shape.
   */
  private void generateSerFunction(Shape shape, BiConsumer<GenerationContext, Shape> functionBody) {
    ...
    boolean mayElide =
        serdeElisionEnabled && SerdeElisionIndex.of(context.getModel()).mayElide(shape);
    if (mayElide) {
  ...
  /**
   * Dispatches to create the body of document shape serialization functions. The function signature
   * will be generated.
   *
   * <p>For example, given the following Smithy model:
   *
  ...
  /**
   * Dispatches to create the body of list shape serialization functions. The function signature
   * will be generated.
   *
   * <p>For example, given the following Smithy model:
   *
  ...
  /**
   * Dispatches to create the body of map shape serialization functions. The function signature will
   * be generated.
   *
   * <p>For example, given the following Smithy model:
   *
  ...
  /**
   * Dispatches to create the body of set shape serialization functions. The function signature will
   * be generated.
   *
   * <p>For example, given the following Smithy model:
   *
  ...
  /**
   * Dispatches to create the body of structure shape serialization functions. The function
  ...
  /**
   * Dispatches to create the body of union shape serialization functions. The function signature
   * will be generated.
   *
   * <p>For example, given the following Smithy model:
   *
