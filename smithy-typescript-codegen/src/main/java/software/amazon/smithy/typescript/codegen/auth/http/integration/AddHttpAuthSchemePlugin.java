...
public final class AddHttpAuthSchemePlugin implements HttpAuthTypeScriptIntegration {
    ...
    public void customize(TypeScriptCodegenContext codegenContext) {
        ...
        codegenContext.writerDelegator().useFileWriter(AuthUtils.HTTP_AUTH_SCHEME_PROVIDER_PATH, w -> {
            ...
            Map<ShapeId, HttpAuthScheme> httpAuthSchemes =
                    AuthUtils
                            .getAllEffectiveNoAuthAwareAuthSchemes(serviceShape, serviceIndex, authIndex, topDownIndex);
            ...
            generateHttpAuthSchemeInputConfigInterface(w,
                    HttpAuthSchemeInputConfigInterfaceCodeSection.builder()
                            ...
                            .build());
            generateHttpAuthSchemeResolvedConfigInterface(w,
                    HttpAuthSchemeResolvedConfigInterfaceCodeSection.builder()
                            ...
                            .resolveConfigFunctions(resolveConfigFunctions)
                            .build());
            generateResolveHttpAuthSchemeConfigFunction(w,
    ...
    private static void identityProviderConfigProvider(
        ...
        w.openCollapsibleBlock("""
                ...
                httpAuthSchemes.values()
                        ...
                        .anyMatch(scheme -> scheme.getConfigFields()
                                .stream()
                                .anyMatch(
    ...
    */
    private void generateResolveHttpAuthSchemeConfigFunction(
        ...
        Map<Symbol, ResolveConfigFunction> previousResolvedFunctions = resolveConfigFunctions.entrySet()
                .stream()
