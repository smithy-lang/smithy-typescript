...
public final class HttpAuthSchemeResolvedConfigInterfaceCodeSection implements CodeSection {
  ...
  private HttpAuthSchemeResolvedConfigInterfaceCodeSection(Builder builder) {
    ...
    resolveConfigFunctions =
        SmithyBuilder.requiredState("resolveConfigFunctions", builder.resolveConfigFunctions);
  }
  ...
  public static class Builder
      implements SmithyBuilder<HttpAuthSchemeResolvedConfigInterfaceCodeSection> {
    ...
    public Builder resolveConfigFunctions(
