 ...
 *
 * <p>HttpAuthScheme defines everything needed to generate an HttpAuthSchemeProvider,
...
public final class HttpAuthScheme implements ToSmithyBuilder<HttpAuthScheme> {
  ...
  public static final class Builder implements SmithyBuilder<HttpAuthScheme> {
    ...
    public Builder putDefaultIdentityProvider(
        LanguageTarget languageTarget, Consumer<TypeScriptWriter> identityProvider) {
    ...
    public Builder putDefaultSigner(
        LanguageTarget languageTarget, Consumer<TypeScriptWriter> signer) {
    ...
    public Builder removeResolveConfigFunction(Symbol resolveConfigFunction) {
      this.resolveConfigFunctions
          .get()
          .removeIf(c -> c.resolveConfigFunction().equals(resolveConfigFunction));
      return this;
    }
