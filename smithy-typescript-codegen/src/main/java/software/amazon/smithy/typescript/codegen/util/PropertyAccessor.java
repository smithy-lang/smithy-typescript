...
public final class PropertyAccessor {
  ...
  public static final Pattern VALID_JAVASCRIPT_PROPERTY_NAME =
   ...
   * @param propertyName - property being accessed.
   * @return e.g. someObject.prop or someObject['property name'] or reluctantly
   *     someObject[`bad"property"name`].
   */
