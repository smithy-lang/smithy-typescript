...
public class ExtensionConfigurationGenerator {
  ...
  void generate() {
      ...
      integration
          ...
          .forEach(
              configurationInterface -> {
                interfaces.put(
                    configurationInterface.name().left, configurationInterface.name().right);
              });
    }
    ...
    String clientConfigurationContent =
        TypeScriptUtils.loadResourceAsString(CLIENT_CONFIGURATION_TEMPLATE)
