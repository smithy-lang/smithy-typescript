...
/**
 * Represents the resolves {@link Symbol}s and references for an application protocol (e.g., "http",
 * "mqtt", etc).
 */
@SmithyUnstableApi
public final class ApplicationProtocol {
  ...
  private static Symbol createHttpSymbol(
      TypeScriptDependency dependency, String symbolName, boolean typeOnly) {
   ...
   *
   * <p>All HTTP protocols should start with "http". All MQTT protocols should start with "mqtt".
   *
