...
public enum TypeScriptDependency implements SymbolDependencyContainer {
    ...
    AWS_SDK_CLIENT_DOCGEN("devDependencies", "@smithy/service-client-documentation-generator", "^1.0.2", true),
    AWS_SDK_TYPES("dependencies", "@aws-sdk/types", true),
    SMITHY_TYPES("dependencies", "@smithy/types", "^1.1.1", true),
    AWS_SMITHY_CLIENT("dependencies", "@smithy/smithy-client", "^1.0.4", true),
    INVALID_DEPENDENCY("dependencies", "@smithy/invalid-dependency", "^1.0.2", true),
    CONFIG_RESOLVER("dependencies", "@smithy/config-resolver", "^1.0.2", true),
    TYPES_NODE("devDependencies", "@types/node", "^14.14.31", true),

    MIDDLEWARE_CONTENT_LENGTH("dependencies", "@smithy/middleware-content-length", "^1.0.2", true),
    MIDDLEWARE_SERDE("dependencies", "@smithy/middleware-serde", "^1.0.2", true),
    MIDDLEWARE_RETRY("dependencies", "@smithy/middleware-retry", "^1.0.4", true),
    UTIL_RETRY("dependencies", "@smithy/util-retry", "^1.0.4", false),
    MIDDLEWARE_STACK("dependencies", "@smithy/middleware-stack", "^1.0.2", true),
    MIDDLEWARE_ENDPOINTS_V2("dependencies", "@smithy/middleware-endpoint", "^1.0.3", false),
    ...
    AWS_SDK_HASH_NODE("dependencies", "@smithy/hash-node", "^1.0.2", true),

    AWS_SDK_URL_PARSER("dependencies", "@smithy/url-parser", "^1.0.2", true),

    @Deprecated AWS_SDK_UTIL_BASE64_BROWSER("dependencies", "@smithy/util-base64-browser", "^1.0.2", false),
    @Deprecated AWS_SDK_UTIL_BASE64_NODE("dependencies", "@smithy/util-base64-node", "^1.0.2", false),
    AWS_SDK_UTIL_BASE64("dependencies", "@smithy/util-base64", "^1.0.2", true),

    AWS_SDK_UTIL_BODY_LENGTH_BROWSER("dependencies", "@smithy/util-body-length-browser", "^1.0.2", true),
    AWS_SDK_UTIL_BODY_LENGTH_NODE("dependencies", "@smithy/util-body-length-node", "^1.0.2", true),

    AWS_SDK_UTIL_UTF8("dependencies", "@smithy/util-utf8", "^1.0.2", true),

    AWS_SDK_UTIL_WAITERS("dependencies", "@smithy/util-waiter",  "^1.0.2", false),

    AWS_SDK_UTIL_DEFAULTS_MODE_NODE("dependencies", "@smithy/util-defaults-mode-node", "^1.0.2", true),
    AWS_SDK_UTIL_DEFAULTS_MODE_BROWSER("dependencies", "@smithy/util-defaults-mode-browser", "^1.0.2", true),

    NODE_CONFIG_PROVIDER("dependencies", "@smithy/node-config-provider", "^1.0.2", false),

    UUID("dependencies", "uuid", "^8.3.2", false),

    // Conditionally added when httpChecksumRequired trait exists
    MD5_BROWSER("dependencies", "@smithy/md5-js", "^1.0.2", false),
    STREAM_HASHER_NODE("dependencies", "@smithy/hash-stream-node", "^1.0.2", false),
    STREAM_HASHER_BROWSER("dependencies", "@smithy/hash-blob-browser", "^1.0.2", false),
    BODY_CHECKSUM("dependencies", "@smithy/middleware-apply-body-checksum", "^1.0.2", false),

    // Conditionally added when using an HTTP application protocol.
    PROTOCOL_HTTP("dependencies", "@smithy/protocol-http", "^1.1.1", false),
    AWS_SDK_FETCH_HTTP_HANDLER("dependencies", "@smithy/fetch-http-handler", "^1.0.2", false),
    AWS_SDK_NODE_HTTP_HANDLER("dependencies", "@smithy/node-http-handler", "^1.0.3", false),

    // Conditionally added when setting the auth middleware.
    AWS_SDK_UTIL_MIDDLEWARE("dependencies", "@smithy/util-middleware", "^1.0.2", false),
    ...
    AWS_SDK_EVENTSTREAM_SERDE_CONFIG_RESOLVER("dependencies", "@smithy/eventstream-serde-config-resolver",
        "^1.0.2", false),
    AWS_SDK_EVENTSTREAM_SERDE_NODE("dependencies", "@smithy/eventstream-serde-node", "^1.0.2", false),
    AWS_SDK_EVENTSTREAM_SERDE_BROWSER("dependencies", "@smithy/eventstream-serde-browser", "^1.0.2", false),
    ...
    AWS_SDK_QUERYSTRING_BUILDER("dependencies", "@smithy/querystring-builder", "^1.0.2", false),
    ...
    @Deprecated UTIL_STREAM_NODE("dependencies", "@smithy/util-stream-node", "^1.0.2", false),
    @Deprecated UTIL_STREAM_BROWSER("dependencies", "@smithy/util-stream-browser", "^1.0.2", false),
    UTIL_STREAM("dependencies", "@smithy/util-stream", "^1.0.2", false),
