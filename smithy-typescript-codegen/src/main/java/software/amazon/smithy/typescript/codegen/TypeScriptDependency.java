...
public enum TypeScriptDependency implements SymbolDependencyContainer {
    ...
    AWS_SDK_URL_PARSER_NODE("dependencies", "@aws-sdk/url-parser-node", "1.0.0-rc.0", true),

    AWS_SDK_UTIL_BASE64_BROWSER("dependencies", "@aws-sdk/util-base64-browser", "1.0.0-rc.0", true),
    AWS_SDK_UTIL_BASE64_NODE("dependencies", "@aws-sdk/util-base64-node", "1.0.0-rc.0", true),
    ...
    AWS_SDK_NODE_HTTP_HANDLER("dependencies", "@aws-sdk/node-http-handler", "1.0.0-rc.0", false),
    ...
    AWS_SDK_EVENTSTREAM_SERDE_CONFIG_RESOLVER("dependencies", "@aws-sdk/eventstream-serde-config-resolver",
            "1.0.0-rc.0", false),
    AWS_SDK_EVENTSTREAM_SERDE_NODE("dependencies", "@aws-sdk/eventstream-serde-node", "1.0.0-rc.0", false),
    AWS_SDK_EVENTSTREAM_SERDE_BROWSER("dependencies", "@aws-sdk/eventstream-serde-browser", "1.0.0-rc.0", false),
    ...
    AWS_SDK_QUERYSTRING_BUILDER("dependencies", "@aws-sdk/querystring-builder", "1.0.0-rc.0", false),
