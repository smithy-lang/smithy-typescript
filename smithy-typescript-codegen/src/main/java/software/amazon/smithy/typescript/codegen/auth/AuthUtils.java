...
public final class AuthUtils {
  ...
  public static final String HTTP_AUTH_SCHEME_PROVIDER_MODULE =
      Paths.get(".", CodegenUtils.SOURCE_FOLDER, HTTP_AUTH_FOLDER, "httpAuthSchemeProvider")
          .toString();

  public static final String HTTP_AUTH_SCHEME_PROVIDER_PATH =
      HTTP_AUTH_SCHEME_PROVIDER_MODULE + ".ts";

  public static final Dependency AUTH_HTTP_PROVIDER_DEPENDENCY =
      new Dependency() {
        @Override
  ...
  public static final String HTTP_AUTH_SCHEME_EXTENSION_MODULE =
      Paths.get(".", CodegenUtils.SOURCE_FOLDER, HTTP_AUTH_FOLDER, "httpAuthExtensionConfiguration")
          .toString();

  public static final String HTTP_AUTH_SCHEME_EXTENSION_PATH =
      HTTP_AUTH_SCHEME_EXTENSION_MODULE + ".ts";

  public static final Dependency AUTH_HTTP_EXTENSION_DEPENDENCY =
      new Dependency() {
        @Override
        public String getPackageName() {
  ...
  public static Map<ShapeId, HttpAuthScheme> getAllEffectiveNoAuthAwareAuthSchemes(
    ...
    for (var operation : topDownIndex.getContainedOperations(serviceShape)) {
      var operationEffectiveAuthSchemes =
          serviceIndex.getEffectiveAuthSchemes(
              serviceShape, operation, AuthSchemeMode.NO_AUTH_AWARE);
    ...
    HttpAuthScheme effectiveSigv4aScheme =
        effectiveAuthSchemes.get(ShapeId.from("aws.auth#sigv4a"));
    HttpAuthScheme supportedSigv4aScheme =
        authIndex.getHttpAuthScheme(ShapeId.from("aws.auth#sigv4a"));
    if (effectiveSigv4Scheme != null
        && effectiveSigv4aScheme == null
        && supportedSigv4aScheme != null) {
  ...
  public static Map<String, ConfigField> collectConfigFields(
  ...
  public static boolean areHttpAuthSchemesEqual(
      Map<ShapeId, Trait> httpAuthSchemes1, Map<ShapeId, Trait> httpAuthSchemes2) {
