...
final class ServerSymbolVisitor extends ShapeVisitor.Default<Symbol> implements SymbolProvider {
  ...
  public Symbol operationShape(OperationShape shape) {
    ...
    builder.putProperty(
        "inputType", intermediate.toBuilder().name(shapeName + "ServerInput").build());
    builder.putProperty(
        "outputType", intermediate.toBuilder().name(shapeName + "ServerOutput").build());
    builder.putProperty("errorsType", intermediate.toBuilder().name(shapeName + "Errors").build());
    builder.putProperty(
        "serializerType", intermediate.toBuilder().name(shapeName + "Serializer").build());
  ...
  public Symbol serviceShape(ServiceShape shape) {
    ...
    builder.putProperty(
        "operations", intermediate.toBuilder().name(serviceName + "Operations").build());
