...
final class PaginationGenerator implements Runnable {
    ...
    public void run() {
        ...
        writer.addRelativeImport(serviceSymbol.getName(),
        ...
        writer.addRelativeImport(paginationType,
                paginationType,
    ...
    static String getOutputFilelocation(OperationShape operation) {
        return Paths.get(CodegenUtils.SOURCE_FOLDER,
                PAGINATION_FOLDER,
    ...
    private static String getModulePath(String fileLocation) {
        return fileLocation.substring(
                ...
                fileLocation.length()).replace(".ts", "");
    }
