...
final class TypeScriptUtils {
  ...
  /**
   * Adds quotes to the given string if quotes are needed to make it a valid JavaScript property
   * name.
   *
   ...
   *
   * <p>This check is pretty simplistic, and the rules around property names are much more complex
   * than this according to ECMA-262, but the primary purpose of this method is to make the
   ...
   *
   * <p>For example, `"foo" | "baz"`. Note: special characters and quotes are escaped as needed.
   *
   ...
   * @return Returns the loaded contents. TODO: this should be a shared feature in smithy-utils
   */
