...
public class SymbolProviderTest {
  ...
  public void createsSymbols() {
    ...
    assertThat(
        symbol.getNamespace(), equalTo("./" + CodegenUtils.SOURCE_FOLDER + "/models/models_0"));
  ...
  public void createsSymbolsIntoTargetNamespace() {
    ...
    assertThat(
        symbol1.getNamespace(), equalTo("./" + CodegenUtils.SOURCE_FOLDER + "/models/models_0"));
    assertThat(symbol1.getNamespaceDelimiter(), equalTo("/"));
    assertThat(
        symbol1.getDefinitionFile(),
        equalTo("./" + CodegenUtils.SOURCE_FOLDER + "/models/models_0.ts"));

    assertThat(symbol2.getName(), equalTo("Hello"));
    assertThat(
        symbol2.getNamespace(), equalTo("./" + CodegenUtils.SOURCE_FOLDER + "/models/models_0"));
    assertThat(symbol2.getNamespaceDelimiter(), equalTo("/"));
    assertThat(
        symbol2.getDefinitionFile(),
        equalTo("./" + CodegenUtils.SOURCE_FOLDER + "/models/models_0.ts"));
  }
  ...
  public void doesNotEscapeBuiltins() {
    MemberShape member =
        MemberShape.builder().id("foo.bar#Object$a").target("smithy.api#String").build();
    ...
    assertThat(
        structSymbol.getNamespace(),
        equalTo("./" + CodegenUtils.SOURCE_FOLDER + "/models/models_0"));
  ...
  public void escapesRecursiveSymbols() {
    ...
    MemberShape listMember =
        MemberShape.builder().id("foo.bar#Records$member").target(record).build();
  ...
  public void omitsUnknownStringEnumVariant() {
    ...
    StringShape stringShape =
        StringShape.builder().id("foo.bar#enumString").addTrait(trait).build();
  ...
  public void omitsUnknownNumberIntEnumVariant() {
    IntEnumShape shape =
        IntEnumShape.builder().id("com.foo#Foo").addMember("BAR", 2).addMember("BAZ", 5).build();
