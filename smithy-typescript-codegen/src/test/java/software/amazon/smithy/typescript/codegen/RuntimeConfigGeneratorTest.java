...
public class RuntimeConfigGeneratorTest {
  ...
  public void expandsRuntimeConfigFile() {
    ...
    RuntimeConfigGenerator generator =
    ...
    Assertions.assertTrue(
        manifest.hasFile(CodegenUtils.SOURCE_FOLDER + "/runtimeConfig.browser.ts"));
    Assertions.assertTrue(
        manifest.hasFile(CodegenUtils.SOURCE_FOLDER + "/runtimeConfig.native.ts"));
    Assertions.assertTrue(
        manifest.hasFile(CodegenUtils.SOURCE_FOLDER + "/runtimeConfig.shared.ts"));
    ...
    assertThat(
        runtimeConfigNativeContents,
        containsString(
            "import { getRuntimeConfig as getBrowserRuntimeConfig } from"
