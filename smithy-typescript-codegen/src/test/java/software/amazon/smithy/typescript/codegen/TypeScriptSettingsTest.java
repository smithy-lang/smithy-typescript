...
public class TypeScriptSettingsTest {
  ...
  LinkedHashSet<ShapeId> protocolShapeIds =
      new LinkedHashSet<>(
  ...
  public void resolveServiceProtocolSelectJson(
      @Mock Model model, @Mock ServiceShape service, @Mock ServiceIndex serviceIndex) {
    ...
    // spec case 1.
    when(serviceIndex.getProtocols(service))
        .thenReturn(
            MapUtils.of(
                rpcv2Cbor, null,
                json1_0, null));
  ...
  public void parseProtocolPriorityJson() {
    ...
    assertEquals(
        ...
        subject
            .getProtocolPriority()
            .getProtocolPriority(ShapeId.from("namespace#Service1"))
            .get(1));
    assertEquals(
        ShapeId.from("namespace#Protocol2"),
        subject
            .getProtocolPriority()
            .getProtocolPriority(ShapeId.from("namespace#Service2"))
            .get(0));
    assertEquals(
        ShapeId.from("namespace#Protocol4"),
        subject
            .getProtocolPriority()
            .getProtocolPriority(ShapeId.from("namespace#Service5"))
            .get(1));
  }
