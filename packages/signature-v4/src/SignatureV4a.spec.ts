...
describe("SignatureV4a", () => {
  it("SignatureV4a credential check", async () => {
    ...
    expect(result.headers["authorization"]).toEqual(
      "AWS4-ECDSA-P256-SHA256 Credential=test-access-key/20240326/test-service/aws4_request, SignedHeaders=x-amz-date;x-amz-region-set;x-amz-security-token, Signature=3045022100e05f26f5ca09db87269cc0abf4eb81b9e3db6f09090aa5f66da481d4fc4f98ea0220712d5752a049aa86ab727e265a33454ea8327d9291989d4ca0e6dc53d1569d69"
    );
  });
});
