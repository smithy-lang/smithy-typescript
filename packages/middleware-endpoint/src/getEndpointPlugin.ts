import { serializerMiddlewareOption } from "@smithy-io/middleware-serde";
import { EndpointParameters, Pluggable, RelativeMiddlewareOptions, SerializeHandlerOptions } from "@smithy-io/types";
