...
import type { RpcV2JsonProtocolHttpAuthSchemeProvider } from "./httpAuthSchemeProvider";
...
export interface HttpAuthExtensionConfiguration {
  ...
  setHttpAuthSchemeProvider(httpAuthSchemeProvider: RpcV2JsonProtocolHttpAuthSchemeProvider): void;
