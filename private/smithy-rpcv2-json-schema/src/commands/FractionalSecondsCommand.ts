 ...
 * ```javascript
 * import { RpcV2JsonProtocolClient, FractionalSecondsCommand } from "@smithy/smithy-rpcv2-json-schema"; // ES Modules import
 * // const { RpcV2JsonProtocolClient, FractionalSecondsCommand } = require("@smithy/smithy-rpcv2-json-schema"); // CommonJS import
