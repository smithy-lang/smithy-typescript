 ...
 * @public
 */
export interface BigDecimalStructure {
 ...
 * @public
 */
export interface BigIntegerStructure {
 ...
 * @public
 */
export interface RpcV2JsonDenseMapsInputOutput {
 ...
 * @public
 */
export interface RpcV2JsonListInputOutput {
 ...
 * @public
 */
export interface RpcV2JsonSparseMapsInputOutput {
 ...
 * @public
 */
export interface TimestampFormatIgnoredIO {
  dateTime?: Date | undefined;
