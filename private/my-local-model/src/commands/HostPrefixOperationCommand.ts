 ...
 * ```javascript
 * import { XYZServiceClient, HostPrefixOperationCommand } from "xyz"; // ES Modules import
 * // const { XYZServiceClient, HostPrefixOperationCommand } = require("xyz"); // CommonJS import
...
export class HostPrefixOperationCommand extends $Command
  ...
  .f(void 0, void 0)
  .ser(se_HostPrefixOperationCommand)
  .de(de_HostPrefixOperationCommand)
  .build() {
