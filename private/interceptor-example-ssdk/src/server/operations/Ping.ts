...
export class PingHandler<Context> implements __ServiceHandler<Context> {
  ...
  async handle(request: __HttpRequest, context: Context): Promise<__HttpResponse> {
    ...
    const steps: __FrameworkSteps<Context> = {
      ...
      invoke: (_op, input, context) => timed("ActivityTime", () => this.operation(input as PingServerInput, context)),
      serialize: (_op, output) => timed("SerializationTime", () => this.serializer.serialize(output as PingServerOutput, serdeContextBase)),
