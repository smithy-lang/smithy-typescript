 ...
 * ```javascript
 * import { RpcV2ProtocolClient, RpcV2CborUnionsCommand } from "@smithy/smithy-rpcv2-cbor"; // ES Modules import
 * // const { RpcV2ProtocolClient, RpcV2CborUnionsCommand } = require("@smithy/smithy-rpcv2-cbor"); // CommonJS import
